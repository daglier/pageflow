<?php
header("Content-Security-Policy: default-src 'self'; script-src 'self'; img-src 'self' data:; style-src 'self' 'unsafe-inline'; font-src 'self';");
...
<head>
    ...
    <script src="views/login/script.js" defer></script>
